...
export const KEYBINDINGS = {
	...
	"app.exit": { defaultKeys: ["ctrl+d", "ctrl+q"], description: "Exit when editor is empty" },
	"app.suspend": {
	...
	"app.ask.toggle": { defaultKeys: "alt+a", description: "Toggle ask mode" },
	"app.recentFile.open.1": { defaultKeys: "alt+1", description: "Open 1st recent file (HTML in Chrome)" },
	"app.recentFile.open.2": { defaultKeys: "alt+2", description: "Open 2nd recent file (HTML in Chrome)" },
	"app.recentFile.open.3": { defaultKeys: "alt+3", description: "Open 3rd recent file (HTML in Chrome)" },
	"app.recentFile.open.4": { defaultKeys: "alt+4", description: "Open 4th recent file (HTML in Chrome)" },
	"app.recentFile.open.5": { defaultKeys: "alt+5", description: "Open 5th recent file (HTML in Chrome)" },
	"app.recentFile.open.6": { defaultKeys: "alt+6", description: "Open 6th recent file (HTML in Chrome)" },
	"app.recentFile.open.7": { defaultKeys: "alt+7", description: "Open 7th recent file (HTML in Chrome)" },
	"app.recentFile.open.8": { defaultKeys: "alt+8", description: "Open 8th recent file (HTML in Chrome)" },
	"app.recentFile.open.9": { defaultKeys: "alt+9", description: "Open 9th recent file (HTML in Chrome)" },
